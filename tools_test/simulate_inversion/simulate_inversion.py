...
def main_inversion(reads_length, multiple_count, single_count, bp, ti, multi, freq, tools, result_info):
...
def parse_parameters(arguments):
    ...
    for ti in range(int(repeat_time)):
        result_info += main_inversion(reads_length, multiple_count, single_count, bp, ti, multi, freq, tools, result_info)

    inv_res = "./data/simulate" + "_inv_" + bp + "_tools.txt"
